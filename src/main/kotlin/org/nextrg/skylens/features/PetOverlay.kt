...
import org.nextrg.skylens.helpers.Other.Companion.animateFloat
import org.nextrg.skylens.helpers.Other.Companion.quad
import org.nextrg.skylens.helpers.Pets
import org.nextrg.skylens.helpers.Pets.Companion.getCurrentPet
import org.nextrg.skylens.helpers.Pets.Companion.getPetLevel
import org.nextrg.skylens.helpers.Pets.Companion.getPetMaxLevel
import org.nextrg.skylens.helpers.Pets.Companion.getPetRarity
import org.nextrg.skylens.helpers.Pets.Companion.getPetRarityText
import org.nextrg.skylens.helpers.Pets.Companion.getPetXp
...
class PetOverlay {
    companion object {
        ...
        private var level: Int = 1; private var maxLevel: Int = 100; private var xp: Float = 0f

        private var transitionY = 0f; private var transitionX = 0f; private var hidden: Boolean = true
    ...
    object PetOverlay {
        ...
        fun prepare() {
            ...
            HudLayerRegistrationCallback.EVENT.register(HudLayerRegistrationCallback { wrap: LayeredDrawerWrapper ->
                wrap.attachLayerAfter(IdentifiedLayer.HOTBAR_AND_BARS,
        ...
        private fun renderBar(drawContext: DrawContext, x: Int, y: Int, width: Int, height: Int, color: Int, radius: Float) {
