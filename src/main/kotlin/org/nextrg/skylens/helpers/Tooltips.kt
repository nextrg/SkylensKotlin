...
class Tooltips {
    companion object {
        private val itemRarities = arrayOf("COMMON", "UNCOMMON", "RARE", "EPIC", "LEGENDARY", "MYTHIC", "DIVINE", "SPECIAL", "VERY SPECIAL", "ULTIMATE", "ADMIN")
        ...
        fun getTooltipMiddle(lines: MutableList<Text>, itemEnch: MutableList<String>): Int {
            ...
            lines.forEachIndexed { i, line ->
                if (itemEnch.any { enchant -> line.toString().lowercase().contains(enchant.replace("ultimate_", "").replace("_", " ")) }) {
