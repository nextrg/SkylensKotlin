...
public class RoundGradientPIPRenderer extends PictureInPictureRenderer<RoundGradientPIPRenderer.State> {
    private State lastState;
    
    public RoundGradientPIPRenderer(MultiBufferSource.BufferSource bufferSource) {
        super(bufferSource);
    }
